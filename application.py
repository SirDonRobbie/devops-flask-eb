...
<body>
    ...
    <p>This app demonstrates CI/CD, Infrastructure as Code, cloud deployment, testing, security awareness and observability.</p>
...
def message():
    ...
    return f"Hello, {name}. Your Flask app has been deployed through a DevOps pipeline!"
